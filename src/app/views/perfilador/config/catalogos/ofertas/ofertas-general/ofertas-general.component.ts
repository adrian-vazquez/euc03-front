...
<form style="overflow-x: hidden; overflow-y: auto ; max-height: 25em;">
      <div class="form-group row flex-column" style="margin-left: 1em">
        <div class="form-floating">
            <input class="form-control form-control-sm col-md-11" placeholder="Oferta Tipo Dirigida">
        </div>

        <div class="form-floating mt-2">
            <input class="form-control form-control-sm col-md-11" placeholder="Oferta Digital">
        </div>

        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" placeholder="Oferta NTD">
        </div>

        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" placeholder="Oferta NTP">
        </div>

        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" placeholder="Oferta ECM">
        </div>

        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" placeholder="Oferta NTB">
        </div>

        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" placeholder="Oferta BAU">
        </div>
        ...
        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" placeholder="Oferta Informativa Fondos">
        </div>
        ...
        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" placeholder="Oferta Primera Búsqueda">
        </div>

        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" placeholder="Oferta Segunda Búsqueda">
        </div>
...
export class OfertasGeneralComponent implements OnInit {
  ...
  openModalEdit(oferta: IOferta) {
    ...
    <div class="form-group row flex-column" style="margin-left: 1em">
        <div class="form-floating">
            <input class="form-control form-control-sm col-md-11" value="${oferta.ofertaTipoDirigida}" placeholder="Oferta Tipo Dirigida">
        </div>

        <div class="form-floating mt-2">
            <input class="form-control form-control-sm col-md-11" value="${oferta.ofertaDigital}" placeholder="Oferta Digital">
        </div>

        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" value="${oferta.ofertaNTD}" placeholder="Oferta NTD">
        </div>

        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" value="${oferta.ofertaNTP}" placeholder="Oferta NTP">
        </div>

        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" value="${oferta.ofertaECM}" placeholder="Oferta ECM">
        </div>

        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" value="${oferta.ofertaNTB}" placeholder="Oferta NTB">
        </div>

        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" value="${oferta.ofertaBAU}" placeholder="Oferta BAU">
        </div>
        ...
        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" value="${oferta.ofertaInformativaFondos}" placeholder="Oferta Informativa Fondos">
        </div>
        ...
        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" value="${oferta.ofertaPrimeraBusqueda}" placeholder="Oferta Primera Búsqueda">
        </div>

        <div class="form-floating  mt-2">
            <input class="form-control form-control-sm col-md-11" value="${oferta.ofertaSegundaBusqueda}" placeholder="Oferta Segunda Búsqueda">
        </div>
